...
# from https://github.com/OSUPCVLab/SegFormer3D/blob/main/architectures/segformer3d.py
...
class SelfAttention(nn.Module):
    def __init__(
        ...
        qkv_bias: whether the linear projection has bias
...
class TransformerBlock(nn.Module):
    def __init__(
        ...
        """
        embed_dim : hidden size of the PatchEmbedded input
        mlp_ratio: at which rate increase the projection dim of the embedded patch in the _MLP component
        num_heads: number of attention heads
        sr_ratio: the rate at which to down sample the sequence length of the embedded patch
        qkv_bias: whether the linear projection has bias
        attn_dropout: the dropout rate of the attention component
...
class MixVisionTransformer(nn.Module):
    def __init__(
        ...
        patch_stride: stride for the convolution in the patch embedding module
        patch_padding: padding for the convolution in the patch embedding module
        mlp_ratio: at which rate increase the projection dim of the hidden_state in the mlp
        num_heads: number of attention heads
